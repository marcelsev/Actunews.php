<?php
    ...
    if (!empty($_POST)) {
        ...
        $password = $_POST['password'] ;//$password = password_hash($_POST['password'], PASSWORD_DEFAULT); # Contient les données du champ #password
...
<main>
 ...
 <!-- Affichge d'une notification d'erreur -->
 <?php if (!empty($errors)): ?>
